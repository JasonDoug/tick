...
# Local
try:
    from tick.termite.shared.call_llm import call_llm
    from tick.termite.shared.utils.python_exe import get_python_executable
except ImportError:
    from tick.shared.call_llm import call_llm
    from tick.shared.utils.python_exe import get_python_executable
...
def install_package(package: str) -> bool:
    ...
    result = run_cmd(
        ["uv", "pip", "install", package, "--python", str(venv_dir)],
        capture_output=True,
        check=True,
    )
